...
{#if $isSpeaking}
  ...
  >
    ...
    <span class="sr-only motion-reduce:not-sr-only motion-reduce:font-mono motion-reduce:text-[10px] motion-reduce:text-accent/70">
      &gt; transmitting...
    </span>
...
<style>
  .waveform-bar {
    width: 3px;
    background-color: oklch(var(--color-accent, 65% 0.22 25) / 0.7);
    border-radius: 1.5px;
