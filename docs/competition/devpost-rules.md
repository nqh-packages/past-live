...
Deadline: Mar 16, 2026 @ 8:00pm [EDT](https://devpost.com/settings/preferences_and_eligibility#eligibility-section)
...
- **Innovation & Multimodal User Experience (40%):**  - The "Beyond Text" Factor: Does the project break the "text box" paradigm? Is the interaction natural, immersive, and superior to a standard chat interface? Does the agent "See, Hear, and Speak" in a way that feels seamless?
  - Category Execution:
...
- **Technical Implementation & Agent Architecture (30%):**  - Google Cloud Native: Does the code effectively utilize the Google GenAI SDK or ADK? Is the backend robustly hosted on Google Cloud (Cloud Run, Vertex AI, Firestore)?
...
- **Demo & Presentation (30%):**  - The Story: Does the video clearly define the problem and the solution?
...
| Live Agent Category | - Maximum of two (2) Google Cloud Next 2026 conference tickets (April 22-24, 2026) ) (Value: $2,299 each)<br>- $10,000 in USD<br>- $1,000 in Google Cloud Credits for use with a [Cloud Billing Account](https://docs.cloud.google.com/billing/docs/how-to/manage-billing-account)<br>- Virtual Coffee with a Google Team Member<br>- Social Promo | 1 | All eligible submissions that enter in the Live Agents category and uses Gemini Live API or the use of ADK. The agents are hosted on Google Cloud. |
| Creative Storyteller Category | - Maximum of two (2) Google Cloud Next 2026 conference tickets (April 22-24, 2026) ) (Value: $2,299 each)<br>- $10,000 in USD<br>- $1,000 in Google Cloud Credits for use with a [Cloud Billing Account](https://docs.cloud.google.com/billing/docs/how-to/manage-billing-account)<br>- Virtual Coffee with a Google Team Member<br>- Social Promo | 1 | All eligible submissions that enter in the Creative Storyteller category and use Gemini's interleaved/mixed output capabilities. The agents are hosted on Google Cloud. |
| UI Navigator Category | - Maximum of two (2) Google Cloud Next 2026 conference tickets (April 22-24, 2026) ) (Value: $2,299 each)<br>- $10,000 in USD<br>- $1,000 in Google Cloud Credits for use with a [Cloud Billing Account](https://docs.cloud.google.com/billing/docs/how-to/manage-billing-account)<br>- Virtual Coffee with a Google Team Member<br>- Social Promo | 1 | All eligible submissions that are in the UI Navigator category and uses Gemini multimodal to interpret screenshots/screen recordings and output executable actions. The agents are hosted on Google Cloud. |
...
| --- | --- | --- | --- |
| **Winner** | **Prize** | **Quantity** | **Eligible** |
| Best Multimodal Integration & User Experience | • $5,000 in USD<br>• $500 in Google Cloud Credits for use with a [Cloud Billing Account](https://docs.cloud.google.com/billing/docs/how-to/manage-billing-account) | 1 | Top scoring projects in that judging criteria |
| Best Technical Execution & Agent Architecture | • $5,000 in USD<br>• $500 in Google Cloud Credits for use with a [Cloud Billing Account](https://docs.cloud.google.com/billing/docs/how-to/manage-billing-account) | 1 | Top scoring projects in that judging criteria |
| Best Innovation & Thought Leadership | • $5,000 in USD<br>• $500 in Google Cloud Credits for use with a [Cloud Billing Account](https://docs.cloud.google.com/billing/docs/how-to/manage-billing-account) | 1 | Top scoring projects in that judging criteria |
...
| --- | --- | --- | --- |
| **Winner** | **Prize** | **Quantity** | **Eligible** |
| Grand Prize | - $25,000 in USD<br>- $3,000 in Google Cloud Credits for use with a [Cloud Billing Account](https://docs.cloud.google.com/billing/docs/how-to/manage-billing-account)<br>- Virtual Coffee with a Google Team Member<br>- Social Promo<br>- Maximum of two (2) Google Cloud Next 2026 conference tickets (April 22-24, 2026) ) (Value: $2,299 each)<br>- Maximum of two (2) travel stipends for airfare and hotel to Google Cloud Next 2026 in Las Vegas, NV (maximum of $3,000 USD each)\*A<br>- Opportunity to demo your Project in a Google Cloud Next 26 presentation (additional requirements below).\*\*B | 1 | All eligible submissions. |
| Honorable Mentions | • $2,000 in USD<br>• $500 in Google Cloud Credits for use with a [Cloud Billing Account](https://docs.cloud.google.com/billing/docs/how-to/manage-billing-account) | 5 | Runners up from all eligible submissions |
...
[Previous image](https://geminiliveagentchallenge.devpost.com/rules)[Next image](https://geminiliveagentchallenge.devpost.com/rules)